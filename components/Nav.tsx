...
export default function Nav() {
  ...
  return (
    <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "22px 48px", position: "sticky", top: 0, zIndex: 50, backgroundColor: "transparent" }}>
      <Link href="/" style={{ fontSize: "13px", fontWeight: 600, letterSpacing: "0.2em", textTransform: "uppercase", color: "#000", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "10px" }}>
      ...
      <div style={{ display: "flex", gap: "28px", alignItems: "center" }}>
        {NAV_LINKS.map(({ href, label }) => {
          ...
          return (
            <Link
              ...
              style={{ fontSize: "12px", fontWeight: 400, letterSpacing: "0.12em", textTransform: "uppercase", color: "#000", textDecoration: "none", fontFamily: "var(--font-space-grotesk), sans-serif" }}
            >
              {label}
            </Link>
          );
        ...
        <div ref={langRef} style={{ position: "relative", display: "flex", alignItems: "center" }}>
          <button
            ...
            className="hover-muted"
            style={{ fontSize: "12px", fontWeight: 400, letterSpacing: "0.12em", textTransform: "uppercase", color: "#000", background: "none", border: "none", cursor: "pointer", fontFamily: "var(--font-space-grotesk), sans-serif", padding: 0, lineHeight: 1 }}
          >
            EN ▾
          </button>
          {langOpen && (
