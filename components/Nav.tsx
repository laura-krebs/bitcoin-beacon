...
export default function Nav() {
  ...
  return (
    <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "22px 48px", position: "sticky", top: 0, zIndex: 50, backgroundColor: "transparent" }}>
      <Link href="/" style={{ fontSize: "12.1px", fontWeight: 600, letterSpacing: "0.2em", textTransform: "uppercase", color: "#000", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "10px" }}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 144 145" aria-hidden focusable="false"
          style={{ height: "31px", width: "auto", fill: "#e8dfcd", flexShrink: 0, position: "relative", top: "-3px" }}>
